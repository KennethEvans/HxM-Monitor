...
public class AFreeChartView extends View implements ChartChangeListener,
    ...
    private void initialize() {
        this.chartMotionListeners = new
                CopyOnWriteArrayList<ChartTouchListener>();
     ...
     */
    private transient CopyOnWriteArrayList<ChartTouchListener>
            chartMotionListeners;
     ...
     * is a point on the screen, not the chart (which may have been scaled
     * up or
    ...
    private void moveAdjustment(MotionEvent ev) {
        ...
        boolean moveTrigger1 = hMove
                && Math.abs(ev.getX(0) - this.singleTouchStartInfo.getX()) >=
				this.moveTriggerDistance;
        boolean moveTrigger2 = vMove
                && Math.abs(ev.getY(0) - this.singleTouchStartInfo.getY()) >=
				this.moveTriggerDistance;
     ...
     * <p/>
     * If the height available on the panel is less than this, then the
     * chart is
     ...
     *
     * @param source        The source point (in Java 2d coordinates).
     * @param startDistance Distance between first and second index points at the start.
     * @param endDistance   Distance between first and second index points at the end.
     * @param angle         An angle between 0 and pi/2 radians (90 degrees).
     */
