...
public class HxMBleService extends Service implements IConstants {
    private final static String TAG = "HxMBLEService";
    ...
    public String createNotificationChannel(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            // Returns null for pre-26 (O) devices.
            return null;
        }
    }
    ...
    private void broadcastUpdate(final String action,
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            intent.putExtra(EXTRA_ACT, values.getActivity() + dateStr);
            intent.putExtra(EXTRA_PA, values.getPa() + dateStr);
            ...
            if (data != null && data.length > 0) {
                ...
                intent.putExtra(
                        EXTRA_DATA,
                        new StringBuilder().append(BleNamesResolver
     ...
     *
     * @param charBat    The battery characteristic.
     * @param charHr     The heart rate characteristic.
    ...
    public void stopSession() {
        ...
        if (mSessionInProgress = mCharCustom != null) {
            setCharacteristicNotification(mCharCustom, false);
        }
        mCharBat = null;
        mCharHr = null;
