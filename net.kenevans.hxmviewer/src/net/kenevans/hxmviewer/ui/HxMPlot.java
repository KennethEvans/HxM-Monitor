...
/**
 * HxMPlot handles plotting for the HxMViewer.
 * 
 * @author Kenneth Evans, Jr.
 */
public class HxMPlot implements IConstants
{
    ...
    /** The HxMViewer that contains this plot. */
    ...
    public HxMPlot(HxMViewer viewer) {
        this.viewer = viewer;
    }
     ...
     * @param model
     */
    public void addModelToChart(HxMFileModel model) {
        if(dataTypes == null) {
