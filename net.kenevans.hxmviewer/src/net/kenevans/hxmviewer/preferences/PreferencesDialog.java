package net.kenevans.hxmviewer.preferences;
...
import net.kenevans.hxmviewer.ui.HxMViewer;

/**
 * PreferencesDialog is a dialog to set the Preferences for HxMViewer. It only
...
public class PreferencesDialog extends JDialog implements IConstants
{
     ...
     * Constructor
     */
    public PreferencesDialog(Component parent, HxMViewer viewer) {
        super();
        this.viewer = viewer;
        if(viewer == null) {
    ...
    private void init() {
        ...
        button.setToolTipText("Set to the HxMViewer default values.");
        button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent ev) {
                Settings settings = new Settings();
                if(settings == null) {
