package net.kenevans.hxmviewer.model;
...
/**
 * Provides constants for classes related to HxM files.
 * 
...
public interface IConstants
{
    ...
    public static final String TAG = "HxMViewer";
    ...
    public static final String TITLE = "HxM Viewer";
    /** The version */
    public static final String VERSION = "1.0.0.0";
    /** The title for the plot. */
    public static final String PLOT_TITLE = "HxM Data";
     ...
     * HKCU/JavaSoft/Prefs.
     */
    public static final String P_PREFERENCE_NODE = "net/kenevans/hxmviewer/preferences";

    /*** The preference name for the default directory for finding HxM files. */
    public static final String P_DEFAULT_DIR = "defaultDir";
    /*** The default value for the default directory for finding HxM files. */
