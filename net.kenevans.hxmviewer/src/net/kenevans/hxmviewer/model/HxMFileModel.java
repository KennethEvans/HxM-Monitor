...
import net.kenevans.hxmviewer.utils.Log;
...
/**
 * HxMFileModel is a model for HxM data.
 * 
 * @author Kenneth Evans, Jr.
 */
public class HxMFileModel implements IConstants
{
    ...
    public HxMFileModel(String fileName) {
    ...
    public static void main(String[] args) {
        System.out.println("Starting " + HxMFileModel.class.getName());
        System.out.println(FILE_PATH);
        HxMFileModel app = new HxMFileModel(FILE_PATH);
